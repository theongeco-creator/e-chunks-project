...
const readingSegments: ReadingSegment[] = [
  ...
  { text: ". " },
  { text: "My favorite actor", type: "noun" },
  { text: " is " },
  ...
  { text: " " },
  { text: "watching TV", type: "verb"  },
  { text: " " },
  { text: "is", type: "verb"  },
  { text: " " },
  { text: "a great way to relax after work", type: "noun" },
  { text: "." },
];
